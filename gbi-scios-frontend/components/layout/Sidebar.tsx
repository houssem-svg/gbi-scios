...
import { LayoutDashboard, FolderKanban, FileText, LogOut, Scale, ShieldAlert } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: "Compliance & Gaps", icon: ShieldAlert, href: "/dashboard/compliance" },
